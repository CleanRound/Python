    ...
    while True: 
        ...
        if choice == ("Y"):
            if Player.demon_silk < 7:
                ...
                print("With a sly smile the Rag man mutters 'Let's do business some other time again'")
...
def outside_sideboss_3(Player):
    ...
    time.sleep(1.5)
    print("'You are aware that the reason why they want me dead is because I beat them in a fair game of poker?")
    ...
    print("If you let me live I will teach you how to spot 'secrets' that even the keenest eyes won't be able to see")
    while True:
        ...
        if choice == ("M"):
            ...
            print("and informs you how to open them. He wishes you well and abandons the hideout")
...
def outside_doom_wizard(Player):
    ...
    if Player.shadow_hunter == True or Player.holy_knight == True:
        ...
        if Player.max_mana > 19:
            ...
            print("You need at least 20 Mana to upgrade CLASS to Doom Wizard")
            input("Press [Enter] to continue your adventure...")
        ...
        while True:
            ...
            if choice == ("Y"):
                if Player.gold < 10000:
                    ...
                    Player.gold -= 10000
                    print("You have gained the Amulet of Ulgak Shield")
...
def blood_pit( Player):
    ...
    while True:
        ...
        print("Test your might and see how far can you reach in the blood pit?")
        ...
        if Choice == ("Y"):
            ...
            print("\033c", end="")
            while True:
                print("Your first Challenger arrives")
            ...
            print("Then get the hell out of here, you coward.")
            break 
