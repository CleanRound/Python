...
def tresure_chest_1(Player):
    while True:
        ...
        choice = input("Do you want to open the chest? Yes (Y); No(N)").upper()

        if choice == ("Y"):
            r = random.random()
            if r < .50:
                Player.gold += 50
                print("You have found 50 gold")
...
def tresure_chest_3(Player):
    while True:
        ...
        if choice == ("Y"):
            ...
            if r < .50:
                Player.gold += 1000
                print("You have found 1000 gold")
                input("Press [Enter] to continue...")
                break
...
def goblin_gamble(Player):
    while True:
        ...
        if choice == ("Y" or "YES"):
            ...
            print("The goblins decided it will be a game of", game_type)
            while True:
...
def dungeon_battle_4(Player):
    ...
    if r < .45:
        ...
        print("You see a maniacal Demonic Abomination. End the wretched beast")
...
def dungeon_battle_6(Player):
    ...
    if r < .45:
        ...
        print("You see a maniacal Demon War Champion. End the wretched demon")
