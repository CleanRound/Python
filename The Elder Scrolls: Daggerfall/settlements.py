    ...
    while True :
        ...
        if choice==("I"):
            ...
            while True: 
                ...
                print("Brimstone Bone Armour-14 PROT, 2x Brimstone and 2x Demon Bone and 700g       [B]")
                ...
                if choice==("R"):
                    ...
                    if Player.ratling_fur<1 or Player.gold<75:
                        print("You need 1x Ratling fur and 75g to craft Ratskin Tunic")
                    ...
                    if Player.imp_tooth<1 or Player.gold<75:
                        print("You need 1x Imp Tooth and 75g to craft Imp Tooth Spear")
                        print("You do not have the resource to craft this item")
                        print("                                                                                            ")
                    ...
                    if Player.demon_bone<1 or Player.gold<100:
                        print("You need 1x Demon Bone and 100g to craft Demon Bone Shiv")
                        print("You do not have the resource to craft this item")
                        print("                                                                                            ")
                    ...
                    if Player.demon_bone<2 or Player.gold<700 or Player.brimstone<2:
                        print("You need 2x Brimstone and 2x Demon Bone and 700g to craft Brimstone Bone Armour")
                        print("You do not have the resource to craft this item")
                        print("                                                                                            ")
            ...
            while True:
                ...
                if choice==("R"):
                    ...
                    if Player.sideboss_2_alive==True:            
                        ...
                        print("Defeat the Sea Beast 'Atumbrath' at the strange caves and we will give you a map to travel through them")
                        ...
                        print("You have defeated the Sea Beast, here is the map. You gain 60 reputation")
                        print("I will mark the nearest settlement 'Bone Valley' outside of the caves")
                        print("You have gained 'Caves Map'")
                        print("                                      ")
            ...
            while True: 
                ...
                if choice==("D"):
                    ...
                    if Player.demon_bone<2 or Player.gold<300:
                        print("You need 2x Demon Bone and 300g to craft Demon Bone Axe")
                    ...
                    if Player.demon_silk<2 or Player.gold<400:
                        print("You need 2x Demon Silk and 400g to craft Silk Armour")
                        print("You do not have enough material to craft this item")
                        print("                                                                                            ")
                    ...
                    if Player.iron_shard<2 or Player.gold<500 or Player.brimstone<2 :
                        print("You need 2x Brimstone and 2x Iron Shard and 500g to craft Brimstone Mace")
                        print("You do not have enough material to craft this item")
                        print("                                                                                            ")
            ...
            while True:
                ...
                if choice==("R"):
                    ...
                    if Player.sideboss_3_alive==True:            
                        ...
                        print("You gain 2000 gold and 50 reputation")
                        print("                                      ")   
                        Player.demon_bone+=5
                        Player.iron_shard+=5
                        Player.brimstone+=5
            ...
            while True:
                ...
                if choice==("P"):
                    ...
                    if Player.shadow_hunter==True or Player.doom_wizard==True:
                        ...
                        print("Welcome back holy child!")
                        print("                             ")
                        
                    else:                        
                        print("You will need over 300 reputation points to upgrade your class to Holy Knight")
                        print("                             ")
                        ...
                        if Player.reputation<300:
                            ...
                            choice=input("Would you like to train to be a Holy Knight? Yes[Y] or No[N] ").upper()
            ...
            while True: 
                ...
                if choice==("R"):
                    ...
                    if Player.ratling_fur<4 or Player.gold<1000 or Player.iron_shard<2:
                        print("You need 4x ratling furs, 2x Iron Shards and 1000g to craft Ratling Death Claws")
                        print("You do not have enough material to craft this item")
                        print("                                                                                            ")
                    ...
                    if Player.demon_silk<2 or Player.gold<1500 or Player.iron_shard<3 or Player.demon_bone<2 :
                        print("You need 2x Demon Silk, 3x Iron Shards, 2x Demon Bones and 1500g to craft Doom Hammer ")
                        print("You do not have enough material to craft this item")
                        print("                                                                                            ")
                    ...
                    if Player.iron_shard<2 or Player.gold<1500 or Player.brimstone<3 or Player.demon_bone<2  :
                        print("You need 3x Brimstone, 2x Iron Shard, 2x Demon Bones and 1500g to craft Heretic Plate Mail")
                        print("You do not have enough material to craft this item")
                        print("                                                                                            ")
                ...
                if choice==("R"):
                    ...
                    if Player.doom_king_alive==False:
                        ...
                        if Player.main_quest==False:
                            ...
                            print("Pug looks at you with wild eyes and mutters")
                            ...
                            print("                                                              ")
                            print_settlement()
                            print(" e continues 'Do you have 3 marks on your chest that looks like a dragon?'")
            ...
            while True: 
                ...
                if choice==("S"):
                    ...
                    if Player.iron_shard<7 or Player.gold<3000:
                        print("You need 7x Iron Shards and 3000g to craft Facebreaker Gauntlet")
                        print("You do not have enough material to craft this item")
                        print("                                                                                            ")
    ...
    while True :
        ...
        if choice==("I"):
            ...
            while True:            
                ...
                if choice==("W"):
                    if Player.diamond<1:
                        print("You do not have enough Diamonds for training")
                        input("Press [Enter] to continue...")
            ...
            while True:            
                ...
                if choice==("G"):
                    ...
                    if Player.demon_bone<6:
                        print("You do not have enough Demon Bones")
                        input("Press [Enter] to continue...")
                    ...
                    if Player.iron_shard<8:
                        print("You do not have enough Iron Shards ")
                        input("Press [Enter] to continue...")
